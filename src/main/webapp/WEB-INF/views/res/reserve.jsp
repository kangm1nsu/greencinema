				...
				<div class="select-seat-information">
					...
					<div class="selected-seats-wrapper">
						<span class="selected-seats-title">좌석번호&nbsp;&nbsp;&nbsp;</span> <span
							class="seatName">선택한 좌석이 없습니다.</span>
					</div>
					...
					<form action="/pay" class="seatForm" method="post">
						...
						<button type="submit" class="reserve-button">
							결제&nbsp;&nbsp;<img src="/img/kakaoPay.png" class=logo><img src="/img/naverPay.png" class=logo><img src="/img/toss.png" class=logo>
						</button>
					</form>
				</div>
			</div>
